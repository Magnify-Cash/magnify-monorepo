...
export const Base = () => {
  ...
  const graphClient = useMemo(() => {
    return createClient({
      url: getProtocolGraphUrl(chain?.id),
        ...
        >
          ...
          <div className="content-wrapper min-vh-100 d-flex flex-column">
            ...
            <div>
              ...
              <div className="alert alert-info fade show ms-5" role="alert">
                <span className="alert-text">
                  Welcome to the NFTY Finance Mumbai Testnet!
                </span>
                <div className="row">
                  <div className="col">
                    <a target="_blank" href="https://faucet.nfty.finance">
                      Testnet Faucet
                    </a>
                  </div>
                </div>
