import { http, useAccount, useAccountEffect, useSignMessage, useConnectors as useConnectors$1, useSwitchChain, useConfig, useConnect as useConnect$1, createConfig, useEnsAddress, useEnsName, useEnsAvatar, useDisconnect, useBalance, WagmiContext, useBlockNumber } from 'wagmi';
...
const isWalletInstalled = (name) => {
    ...
    return !!((ethereum === null || ethereum === void 0 ? void 0 : ethereum[`is${name}`]) ||
        ((ethereum === null || ethereum === void 0 ? void 0 : ethereum.providers) &&
            (ethereum === null || ethereum === void 0 ? void 0 : ethereum.providers.find((provider) => provider === null || provider === void 0 ? void 0 : provider[`is${name}`]))));
};
...
const wallets = Object.keys(walletConfigs).reduce((acc, key) => {
    ...
    const flag = (_b = (_a = config.name) === null || _a === void 0 ? void 0 : _a.replace('Wallet', '').replace(' ', '')) !== null && _b !== void 0 ? _b : target[0].toUpperCase() + target.slice(1);
    const connector = injected({
        target: {
            id: target,
            name: (_d = (_c = config.name) !== null && _c !== void 0 ? _c : config.shortName) !== null && _d !== void 0 ? _d : key,
            provider: (w) => { var _a; return (_a = w === null || w === void 0 ? void 0 : w.ethereum) === null || _a === void 0 ? void 0 : _a[`is${flag}`]; },
        },
    });
    const name = ((_f = (_e = config.name) !== null && _e !== void 0 ? _e : config.shortName) !== null && _f !== void 0 ? _f : key)
        .toLowerCase()
...
const Modal = ({ open, pages, pageId, positionInside, inline, demo, onClose, onBack, onInfo, }) => {
    ...
    const Content = (jsx(ResetContainer, { "$useTheme": (_e = demo === null || demo === void 0 ? void 0 : demo.theme) !== null && _e !== void 0 ? _e : themeContext.theme, "$useMode": (_f = demo === null || demo === void 0 ? void 0 : demo.mode) !== null && _f !== void 0 ? _f : themeContext.mode, "$customTheme": (_g = demo === null || demo === void 0 ? void 0 : demo.customTheme) !== null && _g !== void 0 ? _g : themeContext.customTheme, children: jsxs(ModalContainer, { role: "dialog", style: {
                ...
                position: positionInside ? 'absolute' : undefined,
            }, children: [!inline && (jsx(BackgroundOverlay, { "$active": rendered, onClick: onClose, "$blur": (_h = context.options) === null || _h === void 0 ? void 0 : _h.overlayBlur })), jsxs(Container$7, { style: dimensionsCSS, initial: false, children: [jsx("div", { style: {
                                ...
                                zIndex: 9,
                                transition: 'width 200ms ease',
                            } }), jsxs(BoxContainer, { className: `${rendered && 'active'}`, children: [jsx(AnimatePresence, { initial: false, children: ((_j = context.options) === null || _j === void 0 ? void 0 : _j.disclaimer) &&
                                        context.route === routes.CONNECTORS && (jsx(DisclaimerBackground, { initial: {
                                            ...
                                            ease: [0.25, 0.1, 0.25, 1.0],
                                        }, children: jsx(Disclaimer, { children: jsx("div", { children: (_k = context.options) === null || _k === void 0 ? void 0 : _k.disclaimer }) }) })) }), jsx(AnimatePresence, { initial: false, children: context.errorMessage && (jsxs(ErrorMessage, { initial: { y: '10%', x: '-50%' }, animate: { y: '-100%' }, exit: { y: '100%' }, transition: { duration: 0.2, ease: 'easeInOut' }, children: [jsx("span", { children: context.errorMessage }), jsx("div", { onClick: () => context.displayError(null), style: {
                                                    position: 'absolute',
                                                    right: 24,
                                                    top: 24,
                                                    cursor: 'pointer',
                                                ...
                                                height: 32,
                                                    ...
                                                    context.signInWithEthereum ? (jsxs(Fragment, { children: [!isSignedIn && !((_l = context.options) === null || _l === void 0 ? void 0 : _l.hideTooltips) && (jsx(motion.div, { style: {
                                                                position: 'absolute',
                                                                inset: 0,
                                                                pointerEvents: 'none',
                                                    ...
                                                    !((_m = context.options) === null || _m === void 0 ? void 0 : _m.hideQuestionMarkCTA) && (jsx(InfoButton, { disabled: inTransition, "aria-label": flattenChildren(locales.moreInformation).toString(), onClick: onInfo, initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 }, transition: {
                                                        duration: mobile ? 0 : 0.1,
                                                        delay: mobile ? 0.01 : 0,
...
const useLastConnector = () => {
    ...
    useEffect(() => {
        const init = async () => {
            const id = await (storage === null || storage === void 0 ? void 0 : storage.getItem('recentConnectorId'));
            setLastConnectorId(id !== null && id !== void 0 ? id : '');
        };
        init();
    }, []);
    const update = (id) => {
        storage === null || storage === void 0 ? void 0 : storage.setItem('recentConnectorId', id);
    };
    return {
        lastConnectorId,
...
const ConnectorItem = ({ wallet, isRecent, }) => {
    ...
    */
    ...
    return (jsxs(ConnectorButton, { type: "button", as: deeplink ? 'a' : undefined, href: deeplink ? deeplink : undefined, disabled: context.route !== routes.CONNECTORS, onClick: deeplink
            ...
            }, children: [jsx(ConnectorIcon, { "data-small": wallet.iconShouldShrink, "data-shape": wallet.iconShape, children: (_b = wallet.iconConnector) !== null && _b !== void 0 ? _b : wallet.icon }), jsxs(ConnectorLabel, { children: [isMobile ? (_c = wallet.shortName) !== null && _c !== void 0 ? _c : wallet.name : wallet.name, !((_d = context.options) === null || _d === void 0 ? void 0 : _d.hideRecentBadge) && isRecent && (jsx(RecentlyUsedTag, { children: jsx("span", { children: "Recent" }) }))] })] }));
};
    ...
    return (jsx(PageContent, { style: { width: 312 }, children: jsxs(Container$6, { children: [jsx(ModalContent, { style: { paddingBottom: 0 }, children: jsx(ScrollArea, { height: 340, children: jsxs(WalletList, { "$disabled": !wcUri, children: [walletsIdsToDisplay
                                ...
                                (a, b) => {
                                    ...
                                    return (jsxs(WalletItem, { onClick: () => connectWallet(wallet), style: {
                                            animationDelay: `${i * 50}ms`,
                                        }, children: [jsx(WalletIcon, { "$outline": true, children: iconConnector !== null && iconConnector !== void 0 ? iconConnector : icon }), jsx(WalletLabel, { children: shortName !== null && shortName !== void 0 ? shortName : name })] }, i));
                                                    ...
                                                    justifyContent: 'center',
                                                        ...
                                                        width: '50%',
                                                    }, children: jsx(Spinner$4, {}) }) })) : (MoreIcon) }), jsx(WalletLabel, { children: locales.more })] })] }) }) }), ((_b = context.options) === null || _b === void 0 ? void 0 : _b.walletConnectCTA) !== 'modal' && (jsx("div", { style: {
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
                        gap: 14,
...
const ConnectWithInjector = ({ switchConnectMethod, forceState }) => {
    ...
    */
    ...
    return (jsx(PageContent, { children: jsxs(Container$4, { children: [jsx(ConnectingContainer, { children: jsxs(ConnectingAnimation, { "$shake": status === states$1.FAILED || status === states$1.REJECTED, "$circle": walletInfo.iconShape === 'circle', children: [jsx(AnimatePresence, { children: (status === states$1.FAILED || status === states$1.REJECTED) && (jsx(RetryButton, { "aria-label": "Retry", initial: { opacity: 0, scale: 0.8 }, animate: { opacity: 1, scale: 1 }, exit: { opacity: 0, scale: 0.8 }, whileTap: { scale: 0.9 }, transition: { duration: 0.1 }, onClick: runConnect, children: jsx(RetryIconContainer, { children: jsx(Tooltip, { open: showTryAgainTooltip &&
                                                (status === states$1.FAILED || status === states$1.REJECTED), message: locales.tryAgainQuestion, xOffset: -6, children: jsx(RetryIconCircle, {}) }) }) })) }), walletInfo.iconShape === 'circle' ? (jsx(CircleSpinner, { logo: status === states$1.UNAVAILABLE ? (jsx("div", { style: {
...
const ConnectWithQRCode = ({ switchConnectMethod }) => {
    ...
    return (jsxs(PageContent, { children: [jsxs(ModalContent, { style: { paddingBottom: 8, gap: 14 }, children: [jsx(CustomQRCode, { value: uri, image: wallet === null || wallet === void 0 ? void 0 : wallet.icon, tooltipMessage: isWalletConnectConnector(id) ? (jsxs(Fragment, { children: [jsx(ScanIconWithLogos, {}), jsx("span", { children: locales.scanScreen_tooltip_walletConnect })] })) : (jsxs(Fragment, { children: [jsx(ScanIconWithLogos, { logo: wallet === null || wallet === void 0 ? void 0 : wallet.icon }), jsx("span", { children: locales.scanScreen_tooltip_default })] })) }), showAdditionalOptions ? (jsx(OrDivider, {})) : (hasApps && jsx(OrDivider, { children: locales.dontHaveTheApp }))] }), showAdditionalOptions && ( // for walletConnect
            jsxs("div", { style: {
                    ...
                    justifyContent: 'center',
                    gap: 14,
                }, children: [((_e = context.options) === null || _e === void 0 ? void 0 : _e.walletConnectCTA) !== 'modal' && (jsx(CopyToClipboard, { variant: "button", string: uri, children: ((_f = context.options) === null || _f === void 0 ? void 0 : _f.walletConnectCTA) === 'link'
                            ? locales.copyToClipboard
                            : locales.copyCode })), ((_g = context.options) === null || _g === void 0 ? void 0 : _g.walletConnectCTA) !== 'link' && (jsx(Button, { icon: jsx(ExternalLinkIcon, {}), onClick: openW3M, disabled: isOpenW3M, waiting: isOpenW3M, children: ((_h = context.options) === null || _h === void 0 ? void 0 : _h.walletConnectCTA) === 'modal'
...
const ConnectKitProvider = ({ children, theme = 'auto', mode = 'auto', customTheme, options, onConnect, onDisconnect, debugMode = false, }) => {
    ...
    return createElement(Context.Provider, { value }, jsx(Fragment, { children: jsx(Web3ContextProvider, { enabled: open, children: jsxs(ThemeProvider, { theme: defaultTheme$1, children: [children, jsx(ConnectModal$1, { lang: ckLang, theme: ckTheme, mode: mode, customTheme: ckCustomTheme })] }) }) }));
};
const useContext = () => {
...
const Balance = ({ hideIcon, hideSymbol }) => {
    ...
    return (jsx("div", { style: { position: 'relative' }, children: jsx(AnimatePresence, { initial: false, children: jsx(motion.div, { initial: (balance === null || balance === void 0 ? void 0 : balance.formatted) !== undefined && isInitial
                    ...
                    ease: [0.25, 1, 0.5, 1],
                    delay: 0.4,
                }, children: !address || !isMounted || (balance === null || balance === void 0 ? void 0 : balance.formatted) === undefined ? (jsxs(Container$1, { children: [!hideIcon && jsx(Chain, { id: chain === null || chain === void 0 ? void 0 : chain.id }), jsx("span", { style: { minWidth: 32 }, children: jsxs(PulseContainer, { children: [jsx("span", { style: { animationDelay: '0ms' } }), jsx("span", { style: { animationDelay: '50ms' } }), jsx("span", { style: { animationDelay: '100ms' } })] }) })] })) : !isChainSupported ? (jsxs(Container$1, { children: [!hideIcon && jsx(Chain, { id: chain === null || chain === void 0 ? void 0 : chain.id }), jsx("span", { style: { minWidth: 32 }, children: "???" })] })) : (jsxs(Container$1, { children: [!hideIcon && jsx(Chain, { id: chain === null || chain === void 0 ? void 0 : chain.id }), jsx("span", { style: { minWidth: 32 }, children: nFormatter(Number(balance === null || balance === void 0 ? void 0 : balance.formatted)) }), !hideSymbol && ` ${balance === null || balance === void 0 ? void 0 : balance.symbol}`] })) }, state) }) }));
};
...
const CONNECTKIT_VERSION = '1.7.3';

export { Avatar, CONNECTKIT_VERSION, Chain as ChainIcon, ConnectKitButton, ConnectModal as ConnectKitModalDemo, ConnectKitProvider, Context, SIWEButtonComponent as SIWEButton, SIWEProvider, types as Types, defaultConfig as getDefaultConfig, defaultConnectors as getDefaultConnectors, useChainIsSupported, useChains, useIsMounted, useModal, useSIWE, wallets };
