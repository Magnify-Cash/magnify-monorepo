...
<React.StrictMode>
  <WagmiConfig config={config}>
    ...
    {/* Borrow */}
    <Route path="borrower-dashboard" element={<Pages.BorrowerDashboard title="Borrower Dashboard" />} />
    ...
    {/* Lend */}
    <Route path="lender-dashboard" element={<Pages.LenderDashboard title="Lender Dashboard" />} />
