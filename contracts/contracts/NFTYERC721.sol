...
contract NFTYERC721 is INFTYERC721, ERC721, AccessControl, ReentrancyGuard {
    ...
    bytes32 public constant BASE_URI_SETTER_ROLE =
        keccak256("BASE_URI_SETTER_ROLE");
    ...
    constructor(
        ...
        _setupRole(BASE_URI_SETTER_ROLE, msg.sender);
    ...
    function setBaseURI(
        string memory _baseURI
    ) external nonReentrant onlyRole(BASE_URI_SETTER_ROLE) {
