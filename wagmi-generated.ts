// Generated by @wagmi/cli@0.1.15 on 8/22/2023 at 5:11:43 PM
import {
  useContract,
  UseContractConfig,
  useContractRead,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link nftyFinanceV1ABI}__ and `functionName` set to `"getLoanAmountDue"`.
 */
export function useNftyFinanceV1GetLoanAmountDue<
  TSelectData = ReadContractResult<typeof nftyFinanceV1ABI, 'getLoanAmountDue'>,
>(
  config: Omit<
    UseContractReadConfig<
      typeof nftyFinanceV1ABI,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link inftyFinanceV1ABI}__.
 */
export function useInftyFinanceV1Read<
  TFunctionName extends string,
  TSelectData = ReadContractResult<typeof inftyFinanceV1ABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof inftyFinanceV1ABI, TFunctionName, TSelectData>,
    'abi'
  > = {} as any,
) {
  return useContractRead({
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link inftyFinanceV1ABI}__ and `functionName` set to `"getLoanAmountDue"`.
 */
export function useInftyFinanceV1GetLoanAmountDue<
  TSelectData = ReadContractResult<
    typeof inftyFinanceV1ABI,
    'getLoanAmountDue'
  >,
